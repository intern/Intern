...
class Template {
     ...
     *    </script>
     */
    public static function script($file, $type = 'file') {
        //
    }
    /**
     +------------------------------------------------------------------------------
     ...
     * @version   $Id$
     +------------------------------------------------------------------------------
     * @param $path set path to the templates
     * @return void
     */
    ...
    function render($file) {
        ...
        include inter_join_path($this->path , $file);  // Include the file
